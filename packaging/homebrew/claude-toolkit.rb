...
class ClaudeToolkit < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/zealot00/claude-toolkit/releases/download/v0.3.0/claude-toolkit_darwin_arm64.tar.gz"
      sha256 "e183815ca564240b7b1653b3406eadaf7efd948b397ff491ebcda2bca9440719"
    else
      url "https://github.com/zealot00/claude-toolkit/releases/download/v0.3.0/claude-toolkit_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/zealot00/claude-toolkit/releases/download/v0.3.0/claude-toolkit_linux_arm64.tar.gz"
      sha256 "aed9831236d53af2c8ee65f63cc394e9b7e22b843ace8bb00cf47fd63937a9d6"
    else
      url "https://github.com/zealot00/claude-toolkit/releases/download/v0.3.0/claude-toolkit_linux_amd64.tar.gz"
